//! The layout sweep bodies: every migrated panel × every sweep screen × the
...
pub fn hermies_full_shelf_fits_one_page_at_the_default_window() {
...
pub fn buying_and_trading_are_sane_everywhere() {
    let catalog = pearl_catalog();
    let none = BTreeSet::new();
...
pub fn bolts_shelf_works_with_bolts_catalog_too() {
...
pub fn swag_picker_is_sane_with_a_full_wardrobe() {
...
pub mod challenge_sweep {
    ...
    pub fn every_challenge_phase_is_sane_everywhere() {
        let all = challenges();
        for &screen in &SWEEP_SCREENS {
            for c in &all {
...
pub fn dialogue_lines_are_sane_everywhere() {
...
pub fn settings_overlay_is_sane_everywhere() {
...
pub fn quest_beats_are_sane_everywhere() {
